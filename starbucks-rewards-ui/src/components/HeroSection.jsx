const HeroSection = () => {
    return (
      <section className="w-full flex flex-col md:flex-row items-stretch justify-between px-0 py-0">
        {/* Text Content */}
        <div className="md:w-1/2 mb-10 md:mb-0 text-left  bg-green-100 py-2 px-4 md:px-16 flex flex-col justify-center ">
          ...
          <button className="bg-green-900 text-black items-center px-6 font-semibold  py-3 rounded-full hover:bg-green-800 transition">
            Join now
          </button>
          <p className="text-green-800 text-md mb-6 ">
